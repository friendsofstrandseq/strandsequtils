#' Takes as inout an aggregate prob table and call each segment by the haplotype of the highest probability
#' 
#'@param aggProbTable A matrix containing the logarithm of aggregate probabilities of haplotype states in segments; rows correspond to segments and columns correspond to haplotype states

...
maximumCN = as.numeric(args[2,match("maxCN", as.character(args[1,]))])
haplotypInfo=F
...
print(paste("bin.size =", bin.size, class(bin.size)))
print(paste("K =", K, class(K)))
print(paste("maximumCN =", maximumCN, class(maximumCN)))
